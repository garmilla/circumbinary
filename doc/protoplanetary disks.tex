...
We will use the prescription in Bell \& Lin 2004 for opacity.
...
\textbf{I will add initial surface density and temperature profiles soon. For now, we are using a delta function for the surface density.}
